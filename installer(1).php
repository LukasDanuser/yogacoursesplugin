...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221005_feelyourbody_cfeca39946a6aaae4635_20221005121905_archive.zip';
        const ARCHIVE_SIZE       = '201208715';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'cfeca39-05121905';
        const SECONDARY_PACKAGE_HASH = '4946626-05121905';
        const VERSION            = '1.5.0';
